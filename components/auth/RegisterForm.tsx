...
import { CheckCircle2, User, Mail, Lock, ShieldAlert } from 'lucide-react'
...
export function RegisterForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false)
      alert(t({
        tr: 'Hesap başarıyla oluşturuldu (Demo mod).',
        en: 'Account successfully created (Demo mode).'
      }))
    }, 1000)
  }
      ...
      <GlassCard className="p-8 sm:p-10 bg-white/40 border-white/60 shadow-2xl rounded-3xl relative overflow-hidden">
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              {loading ? t({ tr: 'Hesap Oluşturuluyor...', en: 'Creating Account...' }) : t({ tr: 'Kayıt Ol', en: 'Register' })}
            </Button>
          </form>
