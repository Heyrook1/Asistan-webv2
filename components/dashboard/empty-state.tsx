...
export function EmptyState({ title, description, ctaLabel, ctaHref, icon }: Props) {
  return (
    <div className="rounded-2xl border border-dashed bg-white p-10 text-center">
      <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#0B7F6F]/10 text-[#0b7f6f]">
      ...
      {ctaLabel && ctaHref && (
        <Button asChild className="mt-4 bg-[#0B7F6F] text-white hover:bg-[#09685C]">
