  ...
  tr: {
    ...
    cards: [
      ...
      },
      {
        ...
        description: 'Çoklu hekim, poliklinik ve hasta kuyruğunu kurumsal seviyede koordine edin. Rol bazlı yetkilendirme ve gelişmiş veri izolasyonu ile güvenliği en üst düzeye çıkarın.',
        metadata: ['Multi-Branch Uyumluluk', 'Gelişmiş RLS Güvenliği', 'Çapraz Randevu Orkestrasyonu'],
      },
    ],
  },
  en: {
    ...
    cards: [
      ...
      },
      {
        ...
        metadata: ['Consult to Book', 'Review-Led Trust', 'High-Intent Leads'],
      },
      {
        title: 'General Practice & Enterprise Medical Groups',
        subtitle: 'Enterprise Clinic Group',
        description: 'Coordinate multiple doctors, departments, and patient queues with enterprise-grade visibility. Protect data compliance with Postgres RLS policies and granular role permissions.',
        metadata: ['Multi-Branch Architecture', 'Enterprise RLS security', 'Cross-Department Schedules'],
      },
    ],
  },
}
