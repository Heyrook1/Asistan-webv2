...
import { CalendarDays, Check, CircleX, Smartphone, Calendar, Clock, X, ChevronRight } from 'lucide-react'
...
const PRICING_COPY = {
  tr: {
    ...
    freeAlert: 'Asistan Rezervasyon uygulaması hastalar için ücretsizdir. Uygulama marketlerinden (App Store, Google Play) yakında indirilebilir.',
    ...
    plans: [
      {
        ...
        cta: 'Başlangıç Planı ile Başla',
      },
      {
        note: 'Büyüyen poliklinikler & merkezler',
        features: ['5 Hekim / Personele Kadar', 'Mobil Uygulamada Listelenme', 'Akıllı SMS & Bildirim Akışı', 'Postgres RLS Veri Güvenliği'],
        cta: 'Standart Planı Seç',
      },
      {
        note: 'Çoklu lokasyon & hastane grupları',
        features: ['Sınırsız Lokasyon & Personel', 'Özel Onboarding & Kurulum', '7/24 Telefon Desteği', 'Kurumsal İleri Analiz & Rapor'],
        cta: 'Özel Demo Planla',
      },
    ],
    ...
    rows: [
      ...
      { label: 'Akıllı SMS & Otomatik Hatırlatıcılar', starter: false, standard: true, enterprise: true },
    ...
    demoCta: 'Tanıtım Demosu Planla',
    
    // Scheduler UI Copy
    schedulerTitle: 'Asistan Tanıtım Demosu Planla',
    ...
    bookingSuccessTitle: 'Demo Randevusu Oluşturuldu!',
    ...
    submitBooking: 'Görüşmeyi Rezerve Et',
  },
  en: {
    ...
    freeAlert: 'The Asistan Rezervasyon customer app is free for patients. Coming soon to App Store and Google Play.',
    ...
    plans: [
      ...
      },
      {
        ...
        features: ['Up to 5 Doctors / Staff', 'App Listing & Discovery', 'Automated SMS & Alerts', 'RLS Data Separation'],
        cta: 'Choose Standard',
      },
      {
        note: 'Hospitals & multi-branch groups',
        features: ['Unlimited Staff & Locations', 'Custom Onboarding Setup', '24/7 Telephone Support', 'Enterprise Custom Analytics'],
    ...
    rows: [
      ...
      { label: 'Automated SMS & push notifications', starter: false, standard: true, enterprise: true },
    ...
    demoCta: 'Book Free Demo Call',

    // Scheduler UI Copy
    schedulerTitle: 'Book an Asistan Platform Demo',
    ...
    bookingSuccessTitle: 'Demo Successfully Scheduled!',
    ...
    submitBooking: 'Reserve Demo Slot',
  },
} as const
...
export function PricingSection() {
  ...
  function handleBookDemo(e: React.FormEvent) {
    e.preventDefault()
    if (selectedDate && selectedTime && name && clinic && email) {
