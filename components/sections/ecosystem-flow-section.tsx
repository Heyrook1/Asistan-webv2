...
const FLOW_COPY = {
  tr: {
    ...
    title: 'Klinik operasyonu ve hasta erişimi için tek bağlı döngü',
    description: 'Klinik paneli ve hasta rezervasyonunu bağlayan sade bir döngü. Klinikler operasyonu yönetir; hastalar müsaitlik görüp randevu talebi oluşturur.',
    clinicTitle: 'Klinik Yönetim Paneli',
    clinicDesc: 'Klinikler randevu, hasta kayıtları, hekim takvimleri ve temel analitiği yönetir; mobil ve webden gelen rezervasyon taleplerini alır.',
    clinicFlow: [
      'Randevu, kayıt, analitik ve ekip planlamasını tek panelden yönetin.',
      'Mobil ve webden gelen rezervasyon taleplerini işleyin.',
      'Panel bildirimleriyle ön masa yükünü azaltın; SMS için webhook kurulumu gerekir.',
    ],
    patientTitle: 'Hasta Rezervasyon (Web + Mobil)',
    patientDesc: 'Hastalar yakındaki klinikleri keşfeder, tamamlanmış randevuya bağlı yorumları okur, randevu talebi oluşturur ve hizmeti değerlendirir.',
    patientFlow: [
      'Yakın klinik ve doktorları yorumlarla birlikte keşfedin.',
      'Uygunluk saatine göre randevu talebi oluşturun.',
      'Durum güncellemesi alın, randevuya gidin, geri bildirim bırakın.',
    ],
    multiStaff: 'Çoklu Ekip',
    analytics: 'Operasyon Analitiği',
    liveQueue: 'Rezervasyon Talepleri',
    reminders: 'Bildirimler',
    ratings: 'Değerlendirme',
    rebook: 'Tekrar Randevu',
    flow: 'Döngü',
    center: 'Klinik ⇄ Hasta',
    loop: ['Talep', 'Bildirim', 'Randevu', 'Yorum', 'Tekrar'],
  },
  en: {
    badge: 'Clinic–patient connection',
    title: 'One connected loop for clinic operations and patient access',
    description: 'A simple loop linking the clinic dashboard and patient booking. Clinics run operations; patients see availability and request appointments.',
    clinicTitle: 'Clinic Dashboard',
    clinicDesc: 'Clinics manage appointments, patient records, doctor calendars, and core analytics; they receive booking requests from mobile and web.',
    clinicFlow: [
      'Manage appointments, records, analytics, and team planning in one panel.',
      'Process booking requests from mobile and web.',
      'Reduce front-desk load with in-panel alerts; SMS needs provider setup.',
    ],
    patientTitle: 'Patient Booking (Web + Mobile)',
    patientDesc: 'Patients discover nearby clinics, read reviews tied to completed visits, request appointments, and leave feedback.',
    patientFlow: [
      'Discover nearby clinics and doctors with real reviews.',
      'Request an appointment based on available times.',
      'Get status updates, attend, and leave feedback.',
    ],
    multiStaff: 'Multi Staff',
    analytics: 'Operations Analytics',
    liveQueue: 'Booking Requests',
    reminders: 'Notifications',
    ratings: 'Reviews',
    rebook: 'Rebook',
    flow: 'Flow',
    center: 'Clinic ⇄ Patient',
    loop: ['Request', 'Notify', 'Visit', 'Review', 'Repeat'],
  },
} as const
