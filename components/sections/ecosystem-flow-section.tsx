...
const FLOW_COPY = {
  ...
  en: {
    ...
    title: 'One connected loop for clinic ops and patient access',
    ...
    clinicFlow: [
      ...
      'Reduce front-desk load with in-panel alerts; SMS needs webhook setup.',
    ],
    ...
    patientFlow: [
      ...
      'Request an appointment based on available slots.',
